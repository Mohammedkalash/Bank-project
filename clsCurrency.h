...
private:
    ...
    static string _ConverCurrencyObjectToLine(clsCurrency Currency, string Seperator = "#//#")
    {
        ...
        stCurrencyRecord += Currency.Country()[0] + Seperator;
...
public:
	clsCurrency(enMode Mode, string Country, string CourrencyCode, string CourrencyName, float Rate) {
		_Mode = Mode;
		_Country = Country;
		_CurrencyCode = CourrencyCode;
		_CurrencyName = CourrencyName;
		_Rate = Rate;
